...
const PcHero: FC = () => {
  return (
    <section className="pt-24 relative" style={{ background: 'radial-gradient(circle at 100% 50%, #372AF2 0%, #242424 70%)' }}>
      ...
      <div className="container mx-auto px-8 py-12 relative z-10">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="flex flex-row items-center justify-start gap-16"
        >
          {/* 텍스트 영역 */}
          <h1 className="text-6xl font-bold leading-tight text-white tracking-tight shrink-0">
            <span className="block">한 사람을 위한</span>
            <span className="block">한 사람에 의한</span>

            <span className="block mt-2 text-[#4ade80] whitespace-nowrap">
              나만의 맞춤 설계
            </span>
          </h1>
